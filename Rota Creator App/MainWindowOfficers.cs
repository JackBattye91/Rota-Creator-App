...
namespace Rota_Creator_App
{
    ...
    {
        private void btnAddOfficer_Clicked(object sender, EventArgs e)
        {
            Officer newOfficer = new Officer() { Name = txtOfficerName.Text, Team = txtOfficerTeam.Text);
            Officers.Add(newOfficer);
        }

        private void btnUpdateOfficer_Clicked(object sender, EventArgs e)
        {
        ...
        private void btnDeleteOfficer_Clicked(object sender, EventArgs e)
        {
        ...
        private void btnClearOfficer_Clicked(object sender, EventArgs e)
        {
            clearOfficerForm();
        }
